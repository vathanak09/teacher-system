      ...
      {isTeacherModalOpen && (
        ...
        >
          <div 
            ...
            style={{ width: '100%', maxWidth: '800px', maxHeight: '90vh', overflowY: 'hidden', display: 'flex', flexDirection: 'column', background: 'var(--modal-bg)' }}
          >
            <div style={{ padding: '1.5rem', borderBottom: '1px solid var(--border-color)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'sticky', top: 0, background: 'var(--modal-bg)', zIndex: 10 }}>
              ...
              <form onSubmit={handleSaveTeacher} style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', padding: '1.5rem', borderTop: '1px solid var(--border-color)', background: 'var(--modal-bg)' }}>
