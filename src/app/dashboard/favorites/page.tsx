...
export default function FavoritesPage() {
  ...
  useEffect(() => {
    ...
    const cached_sortOrder = sessionStorage.getItem('favorites_sortOrder');
  ...
  useEffect(() => { 
    sessionStorage.setItem('favorites_sortBy', sortBy); 
    sessionStorage.setItem('favorites_sortOrder', sortOrder); 
  }, [sortBy, sortOrder]);
